...
/**
 * Tests OpenAPI compliance for Deployments endpoints.
 *
 * This test class dynamically validates that all Deployments-tagged endpoints
 * in the OpenAPI spec have corresponding SDK methods and tests.
 */
class DeploymentsTest extends OpenAPITestCase
{
    protected static string $category = 'Deployments';

    public function test_all_deployments_endpoints_have_sdk_methods()
    {
    ...
    public function test_all_deployments_sdk_methods_have_tests()
    {
        $endpoints = static::getEndpointsForTag(static::$category);
        $mapping = OpenAPIEndpointMapper::createMapping($endpoints);
    ...
    public function test_deployments_endpoint_coverage_statistics()
    {
        $endpoints = static::getEndpointsForTag(static::$category);
        $mapping = OpenAPIEndpointMapper::createMapping($endpoints);
        $testedMethods = static::getTestedMethods();
