...
/**
 * Tests OpenAPI compliance for Nginx endpoints.
 *
 * This test class dynamically validates that all Nginx-tagged endpoints
 * in the OpenAPI spec have corresponding SDK methods and tests.
 */
class NginxTest extends OpenAPITestCase
{
    protected static string $category = 'Nginx';

    public function test_all_nginx_endpoints_have_sdk_methods()
    {
    ...
    public function test_all_nginx_sdk_methods_have_tests()
    {
        $endpoints = static::getEndpointsForTag(static::$category);
        $mapping = OpenAPIEndpointMapper::createMapping($endpoints);
    ...
    public function test_nginx_endpoint_coverage_statistics()
    {
        $endpoints = static::getEndpointsForTag(static::$category);
        $mapping = OpenAPIEndpointMapper::createMapping($endpoints);
        $testedMethods = static::getTestedMethods();
