 ...
 *
 * Organizations
 * @method static \Laravel\Forge\Resources\Organization[] organizations()
 * @method static \Laravel\Forge\Resources\Organization organization(string $organizationSlug)
 *
 * Servers
 * @method static \Laravel\Forge\Resources\Server[] servers(string $organizationSlug)
 ...
 * @method static \Laravel\Forge\Resources\Server[] archivedServers(string $organizationSlug)
 ...
 * @method static \Laravel\Forge\Resources\Event[] serverEvents(string $organizationSlug, int $serverId)
 ...
 *
 * PHP
 * @method static \Laravel\Forge\Resources\PHPVersion[] phpVersions(string $organizationSlug, int $serverId)
 ...
 *
 * Sites
 * @method static \Laravel\Forge\Resources\Site[] sites()
 * @method static \Laravel\Forge\Resources\Site[] organizationSites(string $organizationSlug)
 * @method static \Laravel\Forge\Resources\Site organizationSite(string $organizationSlug, int $siteId)
 * @method static \Laravel\Forge\Resources\Site[] serverSites(string $organizationSlug, int $serverId)
 ...
 *
 * Domains
 * @method static \Laravel\Forge\Resources\Domain[] domains(string $organizationSlug, int $serverId, int $siteId)
 ...
 *
 * Heartbeats
 * @method static \Laravel\Forge\Resources\Heartbeat[] heartbeats(string $organizationSlug, int $serverId, int $siteId)
 ...
 *
 * Databases
 * @method static \Laravel\Forge\Resources\Database[] databases(string $organizationSlug, int $serverId)
 ...
 * @method static \Laravel\Forge\Resources\DatabaseUser[] databaseUsers(string $organizationSlug, int $serverId)
 ...
 *
 * Deployments
 * @method static \Laravel\Forge\Resources\Deployment[] deployments(string $organizationSlug, int $serverId, int $siteId)
 ...
 *
 * Webhooks
 * @method static \Laravel\Forge\Resources\Webhook[] webhooks(string $organizationSlug, int $serverId, int $siteId)
 ...
 *
 * Firewall Rules
 * @method static \Laravel\Forge\Resources\FirewallRule[] firewallRules(string $organizationSlug, int $serverId)
 ...
 *
 * Redirect Rules
 * @method static \Laravel\Forge\Resources\RedirectRule[] redirectRules(string $organizationSlug, int $serverId, int $siteId)
 ...
 *
 * Security Rules
 * @method static \Laravel\Forge\Resources\SecurityRule[] securityRules(string $organizationSlug, int $serverId, int $siteId)
 ...
 *
 * Nginx Templates
 * @method static \Laravel\Forge\Resources\NginxTemplate[] nginxTemplates(string $organizationSlug, int $serverId)
 ...
 *
 * Recipes
 * @method static \Laravel\Forge\Resources\Recipe[] recipes(string $organizationSlug)
 ...
 *
 * Scheduled Jobs
 * @method static \Laravel\Forge\Resources\ScheduledJob[] scheduledJobs(string $organizationSlug, int $serverId)
 ...
 * @method static \Laravel\Forge\Resources\BackgroundProcess[] backgroundProcesses(string $organizationSlug, int $serverId)
